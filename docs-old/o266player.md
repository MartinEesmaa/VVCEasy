...
On macOS 10.15.6, I tried build, but it failed, you can have a look for Stack Overflow: [Link there](https://stackoverflow.com/questions/70387126/error-1-and-2-trying-to-compile-vlc-o266player-missing-git-and-txt).
